...
const Sidebar = ({ isOpen, onClose }) => {
  const lessons = [
    ...
    { path: '/event-handling', name: 'Event Handling', component: 'EventHandling' },
    { path: '/async-await', name: 'Async / Await', component: 'AsyncAwait' },
    { path: '/fetch-api', name: 'Fetch API', component: 'FetchAPI' },
